...
import { HeadphoneData } from "@/components/utils/MockData";
import { FaMessage } from "react-icons/fa6";
import { AnimatePresence, motion } from "framer-motion";
import { SlideRight } from "@/components/utils/animations";
    ...
    >
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 h-screen md:h-[700px] relative">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2  pl-20 h-screen md:h-[700px] relative">
          {/* headphone info section */}
          <div className="flex flex-col justify-center py-14 w-max md:py-0 max-w-[500px] xl:max-w-[500px] order-2 md:order-1">
